...
This is a test exercise from iCasei - O melhor Site de Casamento do Brasil.

Icasei exercice - 2016.
...
To run this application locally please follow the steps:
...
Step 3 - Execute the file rubyinstaller-2.1.6.exe and follow the guide in the installation menu, keeping the default folder name.

Step 4 - Execute the file DevKit-mingw64-32-4.7.2-20130224-1151-sfx.exe

	Step 4.1 - The file must be extracted in the same folder where the rubyinstaller was installed, if the default source folder was kept 
			   extract into C:\Ruby21\devkit. If the source folder was changed extract the file into a new devkit folder where ruby was installed previously.
